var SingleDistrictComponent = React.createClass({
    ...
    render: function () {
        ...
        return this.props.isEditing
            ...
            ? <tr>
                <td className="col-md-3"><input className="form-control" size="3"
                                                placeholder="Iveskite apylinkes pavadinima"
                                                value={this.props.district.title}
                                                onChange={this.props.onFieldChange('title')} type="text"/></td>
                <td className="col-md-1"><input className="form-control" size="3" placeholder="Iveskite rinkeju skaiciu"
                ...
                <td className="col-md-1">
                    <button type="button" className="btn btn-danger" onClick={this.props.onDelete(this.props.district)}>
                        Trinti
                    </button>
                </td>
            </tr>
