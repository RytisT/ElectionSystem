        ...
        if (this.state.adding) {
            return (
                <div className=" well col-md-10  col-md-offset-1">
                    ...
                    <form>
                        <div className="col-md-10"><input className="form-control" placeholder="Apylinkes Pavadinimas"
                                                          value={this.props.district.title}
                                                          onChange={this.props.onFieldChange('title')} type="text"/>
                            <input className="form-control" placeholder="Rinkeju skaicius"
            ...
            return (
                <div>
                    <button className="btn btn-block btn-success" type="submit"
                            onClick={this.changeAddingState}>Prideti apylinke
                    </button>
                </div>)
        }
    },
