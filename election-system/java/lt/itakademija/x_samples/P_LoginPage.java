...
/**
 * Class for login page: in this class should only be listed fields, buttons, methods related to Login page
...
public class LoginPage extends PageObject {
    ...
    public LoginPage(WebDriver webDriver, String baseUrl, boolean navigateTo) {
        ...
        if (navigateTo) {
            this.webDriver.navigate().to(baseUrl);
        }
    ...
    public HomePage clickLogin() {
        loginButton.click();
        return new HomePage(webDriver, baseUrl);
    }
    ...
    /**
     * Checks if URL has "login" text in URL - if yes, that means authentication required
     * @return
     */
